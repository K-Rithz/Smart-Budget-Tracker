    ...
    >
      <form className="onboarding-form" onSubmit={handleSubmit}>
        ...
        <div className="onboarding-actions">
          ...
          <button type="button" className="auth-link" style={{ justifySelf: 'center' }} onClick={onSwitchToSignUp}>
            Doesn't have an account? Create one
          </button>
          <button type="button" className="auth-link" style={{ marginTop: '-3rem', justifySelf: 'center' }} onClick={budgetApp.resetAllData}>
            Clear local data
          </button>
        </div>
      </form>
